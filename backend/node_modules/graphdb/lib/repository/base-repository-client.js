...
function () {
  ...
  _createClass(BaseRepositoryClient, [{
    ...
    value: function retryExecution(httpClients, requestBuilder, currentHttpClient) {
      ...
      var username = this.repositoryClientConfig.getUsername();
      var pass = this.repositoryClientConfig.getPass();
      return this.authenticationService.setHttpClient(httpClient).login(username, pass).then(function () {
    ...
    value: function decorateRequestConfig(requestBuilder) {
      var token = this.authenticationService.getAuthentication();
