...
declare class RepositoryClientConfig {
    constructor(endpoints?: string[], headers?: any, defaultRDFMimeType?: string, readTimeout?: number, writeTimeout?: number, username?: string, pass?: string, keepAlive?: boolean);
    /**
     ...
     */
    setUsername(username: string): RepositoryClientConfig;
    /**
     ...
     * @return {RepositoryClientConfig} the current config for method chaining
     */
    setPass(pass: string): RepositoryClientConfig;
    /**
     ...
     */
    setKeepAlive(keepAlive: boolean): ServerClientConfig;
}
...
declare class ServerClientConfig {
    constructor(endpoint?: string, timeout?: number, headers?: Map<string, string>, username?: string, pass?: string, keepAlive?: boolean);
    /**
     ...
     * @return {ServerClientConfig} the current config for method chaining
     */
    setUsername(username: string): ServerClientConfig;
    /**
     * @return {string} the user password
     */
    getPass(): string;
     ...
     * @return {ServerClientConfig} the current config for method chaining
     */
    setPass(pass: string): ServerClientConfig;
    /**
     * @return {boolean} if the user should be re-logged in after token expires
     */
    getKeepAlive(): boolean;
...
declare class AuthenticationService {
     ...
     */
    setHttpClient(httpClient: HttpClient): AuthenticationService;
}
